<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{ route('kanban.index') }}"><img class="img-fluid" src="{{asset('assets/images/logo/logo.png')}}" alt=""></a></div>
        ...
        <div class="nav-right col pull-right right-menu p-0">
            ...
            <li class="onhover-dropdown">
                ...
                <li>
                    <p class="f-w-700 mb-0">You have 4 Notifications<span class="pull-right badge badge-primary badge-pill">4</span></p>
                </li>
