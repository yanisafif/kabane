...
/***/ "./resources/js/page/app/kanban.admin.js":
/*!***********************************************!*\
  !*** ./resources/js/page/app/kanban.admin.js ***!
  \***********************************************/
/*! no exports provided */
...
function setUpAddCol() {
  $('#add-col-btn').click(function () {
    var dataToSend = {
      ...
      colName: "Column ".concat(window.data.length + 1),
      colorHexa: '#24695c'
    };
    window.httpRequest('/col/add', 'POST', dataToSend).then( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(res) {
        var json, col, colDomEl, colorField;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (res.ok && json !== null && json !== void 0 && json.itemId) {
                  col = {
                  ...
                  colDomEl = window.kanban.findBoard("_col".concat(col.id));
                  colorField = colDomEl.querySelector('.col-header-color-btn');
...
function setUpDeleteColumn() {
  var deleteBtns = document.getElementsByClassName('col-header-delete-btn');

  var _iterator = _createForOfIteratorHelper(deleteBtns),
      _step;
  ...
  $('#delete-col-modal').on('hidden.bs.modal', function () {
...
function setUpSettingsConsole() {
  $('#settings-access-btn').click(function () {
    $('#settings-modal').modal('show');
  }); // Wire uninvite person btns

  var _iterator2 = _createForOfIteratorHelper(document.getElementsByClassName('setting-person-uninvite')),
      _step2;
  ...
  $('#settings-invite-btn').click(function () {
    $('#settings-invite-error-message').text('');
    var nameOrEmail = $('#settings-name-field').val();
    ...
    window.httpRequest('/kanban/invite', 'POST', {
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(res) {
        var json, _json$status, person, settingFormEl, itemFormEl;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                $('#settings-invite-error-message').text((_json$status = json.status) !== null && _json$status !== void 0 ? _json$status : 'An error occurred');
              ...
              case 7:
                ...
                settingFormEl = document.createElement('div');
                settingFormEl.classList.add('p-2', 'settings-person-container', 'd-flex');
                settingFormEl.innerHTML = "\n                <div class=\"setting-person-name\">".concat(window.getUserDisplay(person), "</div>\n                <img class=\"setting-person-uninvite\" data-id=\"").concat(json.userId, "\" src=\"").concat(window.location.protocol + '//' + window.location.hostname, "/assets/svg/trash.svg\">\n            ");
                document.getElementById('settings-people-list-container').appendChild(settingFormEl);
                wirePersonUninvite(settingFormEl.querySelector('.setting-person-uninvite')); // Add person to array people

                if (window.people.length >= 2) {
                  $("#settings-noinvited-message").addClass('d-none');
                }

                itemFormEl = document.createElement('option');
...
function wirePersonUninvite(deleteBtn) {
  deleteBtn.onclick = function () {
    var userId = parseInt(deleteBtn.dataset.id);
    window.httpRequest('/kanban/uninvite', 'DELETE', {
      ...
      window.people.splice(window.people.findIndex(function (f) {
        return f.id === userId;
      }), 1);
      ...
      $('#edit-form-select-people').find("option[value='".concat(userId, "']")).remove();
      $('#select-people-creation').find("option[value='".concat(userId, "']")).remove();
      var userEl = deleteBtn.parentNode;
...
function wireColDeleteBtn(deleteBtn) {
  deleteBtn.onclick = function () {
    var colId = parseInt(deleteBtn.parentNode.dataset.id);
    var colObj = window.data.find(function (f) {
      return f.id === colId;
    });
    $('#modal-delete-col-name').text(colObj.name);
    $('#modal-delete-col-yes-btn').click(function () {
...
/***/ 4:
/*!*****************************************************!*\
  !*** multi ./resources/js/page/app/kanban.admin.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/dev/php/kabane/resources/js/page/app/kanban.admin.js */"./resources/js/page/app/kanban.admin.js");
