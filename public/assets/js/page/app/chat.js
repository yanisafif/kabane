...
(function () {
  var datasetDiv = document.getElementById('dataset');
...
function setUpSendMessage() {
  var currentUser = window.people.find(function (f) {
  ...
  $('#message-send-btn').click(function () {
    ...
    httpRequest('/message/add', 'POST', {
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(res) {
        var json, _json$status, errorField, now, date;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                errorField.text((_json$status = json.status) !== null && _json$status !== void 0 ? _json$status : 'An error occurred');
...
function setUpWebsocket() {
  window.Echo["private"]('kanban.' + window.kanbanId).listen('AddedMessage', function (res) {
    var person = window.people.find(function (f) {
      return f.id === res.userId;
    });
...
function addRenderMessage(content, user, dateStr, isCurrentUser) {
  ...
  messageHtml.innerHTML = "\n        <div class=\"message ".concat(isCurrentUser ? 'my-message' : 'other-message pull-right', "\">\n            <div class=\"message-data\">\n                <img class=\"rounded-circle chat-user-img img-30 mr-2\" style=\"vertical-align: bottom; height: 30px;\" \n                    src=\"").concat(window.location.protocol, "//").concat(window.location.hostname, "/").concat(user !== null && user !== void 0 && user.path_image ? '/avatars/' + user.path_image : '/assets/images/dashboard/1.png', "\"/>\n                <strong style=\"margin-right: 10px\"> ").concat((_user$name = user === null || user === void 0 ? void 0 : user.name) !== null && _user$name !== void 0 ? _user$name : 'John doe', " </strong>\n                <i class=\"message-data-time\"> \n                    ").concat(dateStr, "\n                </i>\n            </div>\n            ").concat(content, "\n        </div>\n    ");
...
/***/ 2:
/*!*********************************************!*\
  !*** multi ./resources/js/page/app/chat.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/dev/php/kabane/resources/js/page/app/chat.js */"./resources/js/page/app/chat.js");
